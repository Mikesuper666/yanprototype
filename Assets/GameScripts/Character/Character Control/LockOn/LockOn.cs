...
public class LockOn : LockOnBehaviour
{
    ...
    [Tooltip("True: Hide the sprite when not Lock On, False: Aways show sprite")]
    ...
    {
        Init();
        tpInput = GetComponent<MeleeCombatInput>();
        if (tpInput)
    ...
    public Canvas aimCanvas
    {
        get
        {
            ...
            _aimCanvas = HUDController.instance.GetComponentInParent<Canvas>();
    ...
    }//instantiete aimimage  to canvas

    #region Protected methods

    protected virtual void UpdateLockOn(MeleeCombatInput tpInput)
    {
    ...
    protected virtual void LockOnInput()
    {
        ...
        if (strafeWhileLockOn && !tpInput.cc.locomotionType.Equals(PlayerMotor.LocomotionType.OnlyStrafe))
        {
    ...
    }//Get the input and variables to lock
    ...
    protected virtual void _LockOn(bool value)
    {
