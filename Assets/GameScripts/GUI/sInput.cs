...
/// <summary>
/// Essca classe é reaproveitada do tutorial vInvector
/// </summary>
public class sInput : MonoBehaviour
{
    ...
    private static sInput _instance;
    public static sInput instance
    {
        get
        {
            if (_instance == null)
...
public class GenericInput
{
    ...
    public string buttonName
    {
        get
        {
            if (sInput.instance != null)
            {
                if (sInput.instance.inputDevice == InputDevice.MouseKeyboard) return keyboard.ToString();
                else if (sInput.instance.inputDevice == InputDevice.Joystick) return joystick;
                else return mobile;
            }
            return string.Empty;
        }
