...
[CreateAssetMenu(menuName = "YanProject/Add Basic/Components/Ragdoll Template")]
public class RagdollGenericTemplate : ScriptableObject
{
    [Header("---Bones Names---")]
    ...
    /// <summary>
    /// Pega o  bone para raiz Hips e retorna com componente transform
    /// </summary>
    ...
    Transform GetBone(string boneName, Transform rootTransform)
    {
        ...
        return null;
    }//get bone by name in root hips and return the transform
}
