...
using UnityEditor.Events;
    ...
    public class ItemManager : mMonoBehaviour
    {
        ...
        IEnumerator Start()
        {
            if (instance == null)
            {
                ...
                var genericAction = GetComponent<GenericAction>();
        ...
        /// <param name="equipPointName">EquipPoint name</param>
        /// <returns></returns>
        public Item GetItemInEquipPoint(string equipPointName)
        {
        ...
        /// <param name="indexOfArea">index of equip area</param>
        /// <returns></returns>
        public List<Item> GetItemsInEquipArea(int indexOfArea)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public List<Item> GetAllItemInAllEquipAreas()
        {
            var list = new List<Item>();
        ...
        public virtual IEnumerator CollectItemsWithDelay(List<ItemReference> collection, float onCollectDelay, float textDelay, bool immediate)
        {
            ...
            for (int i = 0; i < collection.Count; i++)
            {
                ...
                if (item != null && ItemCollectionDisplay.Instance != null)
                {
                    ItemCollectionDisplay.Instance.FadeText("Acquired:" + " " + collection[i].amount + " " + item.name, 4, 0.25f);
                }
        ...
        public virtual IEnumerator CollectItemWithDelay(ItemReference itemRef, float onCollectDelay, float textDelay, bool immediate)
        {
            ...
            if (item != null && ItemCollectionDisplay.Instance != null)
            {
                ItemCollectionDisplay.Instance.FadeText("Acquired:" + " " + itemRef.amount + " " + item.name, 4, 0.25f);
            }
